...
apt-get update
apt-get --assume-yes install vim git gitk virtualbox shutter deluge gparted guake gthumb dconf-cli filezilla vlc konsole chrome-gnome-shell com.canonical.notify-osd hardinfo wavebox ttf-mscorefonts-installer
